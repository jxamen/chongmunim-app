...
const TEXT: Record<string, string> = {
  ...
  no_subscription: '확인된 구독이 없어요. 결제했다면 잠시 뒤 「구매 복원」을 눌러 주세요',
  billing_unset: '결제를 준비하고 있어요. 조금만 기다려 주세요',
  billing_unreachable: '결제 확인에 닿지 않아요. 잠시 뒤 「구매 복원」을 눌러 주세요',
  picker_unset: '구글 드라이브 연결을 준비하고 있어요 · 지금은 파일이나 링크로 가져와 주세요',
